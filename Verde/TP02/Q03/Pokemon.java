...
public class Pokemon {
     ...
     * @version 2 - ler nomes e chamar metódo de pesquisa sequencial para a lista
     * 
     ...
     * @var String name - para nome a ser proucurado
     * @var boolean is - teste se há ou não o pokemon
    ...
    public static void main(String args[]) {
        ...
        // Percorra e imprima cada Pokemon da lista
        /*
         * for (Pokemon p : lista) {
         * System.out.println(p.imprimir()); // Assumindo que o método 'imprimir'
         * retorna uma string com as informações
         * // do Pokémon
         * }
         */
        // ler nomes, while diferente de fim
        linha = sc.nextLine();
        while (!linha.equals("FIM")) {
            name = linha; // name recebe o nome do pokemon
            is = pesqS(name, lista);
            // verifica se deu certo
            if (is) {
